        ...
        <table id="videos-table" class="table table-hover table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @can('video.edit')
                        <a href="{{ route('admin.videos.edit.seo', $video) }}" class="btn btn-outline-primary me-1">SEO Fields</a>
                        <a href="{{ route('admin.videos.edit.product', $video) }}" class="btn btn-outline-success me-1">Product Fields</a>
                        @endcan
                    </td>
                    <td>
                        @can('video.edit')
                        ...
                        @endcan
                        @can('video.delete')
                        <form action="{{ route('admin.videos.destroy', $video) }}" method="POST" class="d-inline delete-video-form">
                            @csrf
                            @method('DELETE')
