...
@section('content')
    ...
    @php
        $allReviews = collect(
            $reviews instanceof \Illuminate\Contracts\Pagination\Paginator ? $reviews->items() : $reviews,
        );
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="reviewsTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending-pane"
                            type="button" role="tab" aria-controls="pending-pane" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="rejected-tab" data-bs-toggle="tab" data-bs-target="#rejected-pane"
                            type="button" role="tab" aria-controls="rejected-pane" aria-selected="false">
                                ...
                                <tbody>
                                    @foreach ($allReviews as $index => $review)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $statusColor[$review->status] ?? 'light' }} badge-status">
                                                    {{ ucfirst($review->status) }}
                                                </span>
                                            </td>
                                            <td>
                                                {{ $review->created_at?->format('Y-m-d H:i') }}
                                                <div class="text-muted small">{{ $review->created_at?->diffForHumans() }}
                                                </div>
                                            </td>
                                            <td>
