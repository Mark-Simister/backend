        ...
        <table id="characters-table" class="table table-hover table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ asset($character->image) }}" alt="{{ $character->name }}" style="max-width: 200px; height: auto;">
                    </td>
                    <td>
                        @can('character.edit')
                        <a href="{{ route('admin.characters.edit', $character) }}" class="btn btn-warning me-1">
                            <i class="bi bi-pencil-square"></i> Edit
                        </a>
                        @endcan
                        @can('character.delete')
                        <form action="{{ route('admin.characters.destroy', $character) }}" method="POST" class="d-inline delete-character-form">
                            @csrf
                            @method('DELETE')
