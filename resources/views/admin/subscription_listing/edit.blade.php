                ...
                <form action="{{ route('admin.subscription_listing.update', $subscriptionListing->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subscription_name" class="form-control"
                            value="{{ old('subscription_name', $subscriptionListing->subscription_name) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="price" class="form-control"
                            value="{{ old('price', $subscriptionListing->price) }}" required>
                        @error('price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="duration" class="form-control"
                            value="{{ old('duration', $subscriptionListing->duration) }}" required>
                        @error('duration')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="duration_unit" class="form-select" required>
                            <option value="month"
                                {{ old('duration_unit', $subscriptionListing->duration_unit) == 'month' ? 'selected' : '' }}>
                                Month</option>
                            <option value="year"
                                {{ old('duration_unit', $subscriptionListing->duration_unit) == 'year' ? 'selected' : '' }}>
                                Year</option>
                        </select>
                        @error('duration_unit')
                            <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" class="form-select" required>
                            <option value="one_time"
                                {{ old('type', $subscriptionListing->type) == 'one_time' ? 'selected' : '' }}>One-time</option>
                            <option value="recurring"
                                {{ old('type', $subscriptionListing->type) == 'recurring' ? 'selected' : '' }}>Recurring
                            </option>
                        </select>
                        @error('type')
                            <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="form-group mt-3">
                        ...
                        @foreach ($regions as $region)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="regions[]" value="{{ $region->id }}"
                                    {{ in_array($region->id, old('regions', $selectedRegions ?? [])) ? 'checked' : '' }}>
