    ...
    <form action="{{ route('admin.forms.update', $form) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select name="cta_type" class="form-select" required>
                <option value="apply_now" {{ old('cta_type', $form->cta_type) == 'apply_now' ? 'selected' : '' }}>Apply Now
                </option>
                <option value="reachout" {{ old('cta_type', $form->cta_type) == 'reachout' ? 'selected' : '' }}>Reachout
                </option>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            @if ($form->video_thumbnail)
                ...
                <img src="{{ asset($form->video_thumbnail) }}" alt="Video Thumbnail" width="150"
