            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-2 mb-2 mb-md-0 text-center">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="fields[${fieldIndex}][required]" value="1" id="required-${fieldIndex}">
                        <label class="form-check-label" for="required-${fieldIndex}">Required</label>
                    </div>
                </div>
