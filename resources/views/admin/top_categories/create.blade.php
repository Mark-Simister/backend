...
@section('title', 'Add Top Category')
@section('content')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Add Top Category</h2>
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.top-categories.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <select name="category_type" id="category_type" class="form-select" required>
                    ...
                    <option value="pet" {{ old('category_type') == 'pet' ? 'selected' : '' }}>Pet</option>
                    <option value="people" {{ old('category_type') == 'people' ? 'selected' : '' }}>People</option>
                </select>
                @error('category_type')
            ...
            <input type="hidden" name="comment_types" id="selected_comment_types" />
            ...
            <div class="mb-3">
                ...
                <div class="mt-2 small text-muted">
                    ...
                    <strong id="videoDurationText">Not loaded</strong>
                </div>
...
$(document).ready(function () {
    ...
    function renderVideos(cat) {
        ...
        const selectedIds = (oldSelected || []).map(id => String(id));
    ...
    function renderComments(selectedTypes) {
        ...
        $selectedCommentIds.val(JSON.stringify(ids));
