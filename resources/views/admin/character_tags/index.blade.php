                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('character_tag.edit')
                                            <a href="{{ route('admin.character_tags.edit', $characterTag) }}"
                                                class="btn btn-warning me-1">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                        @endcan
                                        @can('character_tag.delete')
                                            <form action="{{ route('admin.character_tags.destroy', $characterTag) }}"
                                                method="POST" class="d-inline delete-character-tag-form">
                                                @csrf
                                                @method('DELETE')
